<section class="integrations integrations-double">
                ...
                <div class="carousel-border">
                    <div class="carousel-wrapper slide-to-right animate">
                        ...
                        <div class="logo-border">
                            ...
                            <?php 
                            $repeater_rows = get_field('integrations_multi_logo_rep');
                            $row_count = $repeater_rows ? count($repeater_rows) : 0;
                            $all_children = $row_count;

                            // echo 'Liczba wierszy w repeaterze: ' . $row_count;
                            ?>
                            <?php if( have_rows('integrations_multi_logo_rep') ): ?>
                            <?php while( have_rows('integrations_multi_logo_rep') ): the_row(); 
                            $child_number = get_row_index();
                            ?>
                            <div class="box-logo logo--<?php echo get_row_index(); ?>" style="
                            --all-children:<?php echo $all_children; ?>;
                            --child-number:<?php echo $child_number; ?>;
                            ">
                                <?php 
                                        $image = get_sub_field('carrier_logo');
                                        $size = 'full';
                ...
                <div class="txt fade animate">
                    <div class="main-title-border">
                        <span class="main-title h-40">
                            <?php the_field('integrations_multi_title') ?>
                        </span>
                    </div>
                    <div class="desc-border">
                        <span class="desc body-18">
                            <?php the_field('integrations_multi_desc') ?>
                        </span>
                    </div>
                    <div class="thin-info-border">
                        <span class="thin-info body-18">
                            <i><?php the_field('integrations_multi_question') ?></i>
                        </span>
                    </div>
                    <div class="button-border">
                        <?php 
                        $link = get_field('integrations_multi_link');
                        if($link): 
                        $link_url = $link['url'];
