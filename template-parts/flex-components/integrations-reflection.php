<section class="integrations-reflection">
    <div class="integrations-reflection__outer">
        <div class="integrations-reflection__inner">
            <div class="integrations-reflection__wrapper">
                <div class="txt desktop fade animate">
                    <div class="main-title-border">
                        <span class="main-title h-40">
                            <?php the_field('integrations_title-reflection') ?>
                        </span>
                    </div>
                    <div class="desc-border">
                        <span class="desc body-18">
                            <?php the_field('integrations_desc-reflection') ?>
                        </span>
                    </div>
                    <div class="thin-info-border">
                        <span class="thin-info body-18">
                            <i><?php the_field('integrations_question-reflection') ?></i>
                        </span>
                    </div>
                    <div class="button-border">
                        <?php 
                        $link = get_field('integrations_link-reflection');
                        if($link): 
                        $link_url = $link['url'];
                ...
                <div class="carousel-border">
                    <div class="carousel-wrapper slide-to-left animate">
                        ...
                        <div class="logo-border">
                            ...
                            <div class="box-logo logo-1">
                                <?php 
                                $image = get_field('integrations_logo-reflection_1');
                                $size = 'full';
                            ...
                            <div class="box-logo logo-2">
                                <?php 
                                $image = get_field('integrations_logo-reflection_2');
                                $size = 'full';
                                $attr = array('class' => 'logo');
                                if($image){
                                    echo wp_get_attachment_image($image, $size, false, $attr);
                            ...
                            <div class="box-logo logo-3">
                                <?php 
                                $image = get_field('integrations_logo-reflection_3');
                                $size = 'full';
                                $attr = array('class' => 'logo');
                                if($image){
                                    echo wp_get_attachment_image($image, $size, false, $attr);
                            ...
                            <div class="box-logo logo-4">
                                <?php 
                                $image = get_field('integrations_logo-reflection_4');
                                $size = 'full';
                                $attr = array('class' => 'logo');
                                if($image){
                                    echo wp_get_attachment_image($image, $size, false, $attr);
                            ...
                            <div class="box-logo logo-5">
                                <?php 
                                $image = get_field('integrations_logo-reflection_5');
                                $size = 'full';
                                $attr = array('class' => 'logo');
                                if($image){
                                    echo wp_get_attachment_image($image, $size, false, $attr);
                            ...
                            <div class="box-logo logo-6">
                                <?php 
                                $image = get_field('integrations_logo-reflection_6');
                                $size = 'full';
                                $attr = array('class' => 'logo');
                                if($image){
                                    echo wp_get_attachment_image($image, $size, false, $attr);
                            ...
                            <div class="box-logo logo-7">
                                <?php 
                                $image = get_field('integrations_logo-reflection_7');
                                $size = 'full';
                            ...
                            <div class="box-logo logo-8">
                                <?php 
                                $image = get_field('integrations_logo-reflection_8');
                                $size = 'full';
                                $attr = array('class' => 'logo');
                                if($image){
                                    echo wp_get_attachment_image($image, $size, false, $attr);
                ...
                <div class="txt mobile fade animate">
                    <div class="main-title-border">
                        <span class="main-title h-40">
                            <?php the_field('integrations_title-reflection') ?>
                        </span>
