<section class="simple">
    <div class="simple__outer">
        <div class="simple__inner" id="dostawy">
                    ...
                    <div class="center">
                        <div class="center__wrapper">
                            <div class="center__left-container slide-to-right animate">
                                <div class="center__left-main-title h-32"><?php the_field('simple_title-bold') ?>
                                </div>
                            </div>
                            <div class="list-wrapper slide-to-left animate">
                                <?php the_field('simple_wysiwyg'); ?>
                                <?php $simple_first_desc = get_field('simple_first-desc');
                            if(!empty($simple_first_desc)) : ?>
                                <div class="center__first-txt">
                                    <span class="body-16"><?php the_field('simple_first-desc') ?></span>
                                </div>
                                <?php endif;  ?>

                                <?php $simple_second_desc= get_field('simple_second-desc');
                            if(!empty($simple_second_desc)) : ?>
                                <div class="center__second-txt">
                                    <span class="body-16"><?php the_field('simple_second-desc') ?></span>
                                </div>
                                <?php endif;?>
                                <?php $simple_list = get_field('simple_list');
