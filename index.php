            ...
            <div class="blog-page__inner">
                <div class="blog-page__top">
                    ...
                    <div class="blog-page__top-btn fade animate">
                        <!-- <span class="blog-page__top-btn-text body-16"><?php //_e('Szukaj', 'happy'); ?></span> -->
                ...
                <div class="blog-page__content ">
                    ...
                    <?php
                            $post_counter++;
                            if ($post_counter >= ($paged === 1 ? 5 : 16)) break; 
                        endwhile;
                    ...
                    <div class="blog-page__pagination">
                      ...
                      ?>
                        ...
                        for ($i = 1; $i <= $max_pages; $i++) {
                            ...
                            $active_class = ($i == $current_page) ? 'active-btn' : '';
                            ?>
            ...
            <div class="blog-page__inner">
                ...
                <div class="blog-page__content">
                   ...
                   $paged = (get_query_var('paged')) ? absint(get_query_var('paged')) : 1;
                    ...
                    // Dla pierwszej strony wyświetlamy 5 postów, w tym jeden "big"
                    $posts_per_page = 16;
                    ...
                    if ($custom_query->have_posts()) :
                        ...
                        // Wyświetlamy pierwszy post jako "big" tylko na pierwszej stronie
                        if ($paged === 1 && $custom_query->have_posts()) :
                            $custom_query->the_post();
                    ?>
                    <div class="blog-page__big">
                        <div class="blog-page__big-item">
                    ...
                    <?php
                        ...
                        // Reszta postów (zaczynamy od drugiego na stronie 1)
    ...
    <section>
        <div class="blog-page__outer">
            <div class="blog-page__inner">
                ...
                <div class="blog-page__content">
                    <?php
                    $paged = isset($_GET['strona']) ? (int)$_GET['strona'] : 1;
                    $posts_per_page = ($paged === 1) ? 5 : 16;
                    $offset = ($paged === 1) ? 0 : 5 + ($paged - 2) * 16;
            ...
            <div class="blog-page__inner">
                ...
                <div class="blog-page__content">
                    ...
                    $args = array(
                        ...
                        'order' => 'ASC',   // Malejące, czyli od najnowszych
                    );
